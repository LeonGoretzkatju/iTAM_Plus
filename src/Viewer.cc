...
//        pangolin::Var<bool> menuShowCubePoints("menu.Show Cube Points", true, true);
//        pangolin::Var<bool> menuShowCubeBboxs("menu.Show Cube Bboxs", true, true);
//        pangolin::Var<bool> menuDrawPlanePolygon("menu.Draw Plane Polygon", true, true);
//        pangolin::Var<bool> menuDrawPlaneDiscretePoints("menu.Draw Plane Discrete Points", true, true);
        pangolin::Var<bool> menuShowLines("menu.Show Lines", true, true);
//        pangolin::Var<bool> menuShowPlaneIntersections("menu.ShowIntersections", true, true);
...
//        pangolin::Var<bool> menuShowOuterPlanes("menu.Show Outer Planes",true,true);
...
//        pangolin::Var<bool> menuTextLayoutComposition("menu.Text Layout Composition", true, true);
